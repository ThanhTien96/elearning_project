        ...
        styleCSS ? 'translate-x-0' : 'translate-x-72',
          ...
          <div className="w-full md:w-40 xl:w-80 mr-3 py-3 px-1 md:p-0">
            <div className="input-group relative flex  w-full">
              <input type="search" className="form-control relative flex-auto min-w-0 block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded-l-lg transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-green-600 focus:outline-none placeholder:text-sm" placeholder="Tìm Kiếm Khóa Học" aria-label="Search" aria-describedby="button-addon2" />
              <button className="btn inline-block p-2 py-2.5 bg-green-700 text-white font-medium text-xs leading-tight uppercase rounded-r-lg shadow-md hover:bg-green-800 hover:shadow-lg focus:bg-green-600  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-green-900 active:shadow-lg transition duration-150 ease-in-out flex items-center" type="button" id="button-addon2">
