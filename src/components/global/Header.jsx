          ...
          <nav id='openNav' className={clsx(styles.navMenu, 'md:translate-x-0',
            ...
            <div className="w-full md:w-40 xl:w-80 mr-3 py-3 px-1 md:p-0">
              <div className="input-group relative flex  w-full">
                ...
                <button className="btn p-2 py-2.5 bg-green-700 text-white font-medium text-xs leading-tight uppercase rounded-r-lg shadow-md hover:bg-green-800 hover:shadow-lg focus:bg-green-600  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-green-900 active:shadow-lg transition duration-150 ease-in-out flex items-center" type="button" id="button-addon2">
